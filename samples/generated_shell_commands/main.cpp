// This sample shows how to use the New-ShellCommand.ps1 script to generate a command line argument
...
// 
// For each command, New-ShellCommand.ps1 will generate a constructor that defines the arguments.
// It will also generate an ookii::register_shell_commands() function, which registers the commands
// and returns a shell_command_manager.
//
...
//
// This main.cpp file is empty (and indeed, doesn't need to exist at all) because New-ShellCommand.ps1 is
...
//
// If you don't use "-GenerateMain", you can call ookii::register_shell_commands() manually. Include
