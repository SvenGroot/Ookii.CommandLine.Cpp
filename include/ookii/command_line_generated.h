...
//! \brief Provides helpers for using the New-Parser.ps1 and New-ShellCommand.ps1 scripts.
...
#ifdef OOKII_SHELL_COMMAND_H_
namespace ookii
{
    //! \brief Function that registers all the shell commands generated by New-ShellCommand.ps1.
    //! 
    //! When using New-ShellCommand.ps1, the definition of this method will be generated.
    //! 
    //! This method will be declared for use with `wchar_t` if _UNICODE is defined; otherwise, it
    //! uses `char`.
    basic_shell_command_manager<details::default_char_type> register_shell_commands(std::basic_string<details::default_char_type> application_name);
}
#endif
