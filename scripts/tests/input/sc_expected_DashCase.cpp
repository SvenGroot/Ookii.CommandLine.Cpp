...
{
    builder
        .add_argument(this->test_arg, "test-arg").required().positional().description("Argument description with a line break.\n\nAnd another paragraph.")
        .add_argument(this->__test__arg2__, "test-arg2").positional().default_value(1).value_description("desc").alias("test").description("Short description.")
        .add_multi_value_argument(this->test_arg3, "foo").alias("t").alias("v")
        .add_argument(this->_testArg4, "test-arg4").cancel_parsing()
        .add_argument(this->TestArg5, "test-arg5").default_value("foo");
}
    ...
    : ookii::shell_command{builder}
{
    builder
        ...
        .add_argument(this->_some_arg, "some-arg");
}
...
{
    builder
        .add_argument(this->_other_arg, "other-arg");
}

ookii::basic_shell_command_manager<char> ookii::register_shell_commands(std::basic_string<char> application_name)
{
    basic_shell_command_manager<char> manager{application_name};
    manager
